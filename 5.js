...
(function() {
    ...
    const CONFIG = {
        ...
        AVATAR_SELECTOR: '.avatar_f9f2ca:not(.replyAvatar_f9f2ca)',
    ...
    const extractUserInfo = (message) => {
        ...
        const timestamp = timestampElement ? timestamp.getAttribute('datetime') : '';
    ...
    DiscordUI.extractUserInfo = extractUserInfo;
